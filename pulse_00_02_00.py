...
class pulse:
    def __init__(self, distribution_1, distribution_2=None, pattern_pulse=None, n_steps=1000, include_rate=0.5):
        ...
        if pattern_pulse is None:
            ...
            self.distribution_1 = pattern_pulse.distribution_1
            self.n_steps = pattern_pulse.n_steps
            self.include_rate = pattern_pulse.include_rate
            self.fraction = pattern_pulse.fraction
            self.step = pattern_pulse.step
            self.cdf_1 = pattern_pulse.cdf_1
            self.cdf_spline_1 = pattern_pulse.cdf_spline_1
            self.spline_1 = pattern_pulse.spline_1
            self.density_fraction_1 = pattern_pulse.density_fraction_1
            self.area_1 = pattern_pulse.area_1
            # self.scaled_cdf_1 = pattern_pulse.scaled_cdf_1
            self.scaled_density_fraction_1 = pattern_pulse.scaled_density_fraction_1
        if distribution_2 is None:
            self.cdf_2 = None
            self.spline_2 = None
